        ...
        <DialogContent>
          <DialogContentText>
            ...
            <div className="container-text">
              ...
              {errors.description && (
                <div className="red-color error-margin">{errors.description}</div>
              )}
            </div>
            ...
            <div className="container-product-amount">
              ...
              {errors.product_id && (
                <div className="red-color error-margin">{errors.product_id}</div>
              )}
            </div>

            <div className="container-product-amount">
              <div className="center-items">
                <label htmlFor="quantity_required" className="label-title">
                  Quantity:
                </label>
                <TextField
                  type="number"
              ...
              {errors.quantity_required && (
                <div className="red-color error-margin">{errors.quantity_required}</div>
              )}
            </div>
